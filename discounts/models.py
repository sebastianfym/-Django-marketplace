...
class Discount(models.Model):
    ...
    goods_1 = models.ManyToManyField(Goods, blank=True, related_name='goods_1', verbose_name=_('goods_1'))
    category_1 = models.ManyToManyField(Category, blank=True, related_name='category_1', verbose_name=_('category_1'))
    goods_2 = models.ManyToManyField(Goods, blank=True, related_name='goods_2', verbose_name=_('goods_2'))
    category_2 = models.ManyToManyField(Category, blank=True, related_name='category_2', verbose_name=_('category_2'))
